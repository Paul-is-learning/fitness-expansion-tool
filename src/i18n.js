...
(function () {
  ...
  const T = {
    fr: {
      ...
      'bp.s4.subtitle': 'Staff, loyer, OPEX ops, royalties MF, fonds pub. Total OPEX ~40% CA à maturité → EBITDA 55%+. Calibré sur OnAir (44,7% EBITDA observé) avec buffer prudent +10pp.',
    ...
    en: {
      ...
      'bp.s4.subtitle': 'Staff, rent, OpEx, MF royalties, marketing fund. Total OpEx ~40% revenue at maturity → EBITDA 55%+. Calibrated on OnAir (44.7% observed) with a +10pp prudent buffer.',
