...
(function () {
  ...
  const T = {
    fr: {
      ...
      'bp.s3.subtitle': 'Ouvertures progressives (40 clubs A7). CA enseigne : 0,88 M€ A1 → 10,3 M€ A3 → 51,3 M€ A10. Ramp-up par club : 70% / 90% / 100% en 3 ans.',
    ...
    en: {
      ...
      'bp.s3.subtitle': 'Progressive openings (40 clubs Y7). Brand revenue: 0.88 M€ Y1 → 10.3 M€ Y3 → 51.3 M€ Y10. Per-club ramp: 70% / 90% / 100% over 3 years.',
