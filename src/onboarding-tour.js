  ...
  function demoBpCapex() {
    ...
    return `
      <div style="width:100%;display:flex;flex-direction:column;gap:12px;align-items:center;position:relative">
        ...
        <div style="text-align:center"><div style="font-size:10px;color:rgba(255,255,255,.55);letter-spacing:.8px;text-transform:uppercase">CAPEX bilan / club</div><div style="font-size:24px;font-weight:900;color:var(--onb-tint);margin-top:2px;text-shadow:0 0 20px rgba(212,160,23,.4)"><span data-counter data-target="1176" data-format="fr-thousands" data-suffix=" k€" data-delay="800">0</span></div><div style="margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,.08);font-size:9.5px;color:rgba(255,255,255,.65);letter-spacing:.3px"><span style="color:rgba(255,255,255,.5)">+ leasing 504 k€ (60% équip · 5 ans) →</span> <span style="color:#34d399;font-weight:800">Total cash + leasing <span data-counter data-target="1680" data-format="fr-thousands" data-suffix=" k€" data-delay="1100">0</span></span></div></div>
      </div>
    `;
  }
