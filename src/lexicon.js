...
(function () {
  ...
  const TERMS = [
    ...
    { rx: /\bpoint mort\b/i, t: 'Point mort (en adhérents)',
      d: 'Nombre de membres stabilisés nécessaires pour que le club soit neutre en cash bas de page (FCFE = 0 : l’EBITDA couvre le leasing et le service de la dette). Calculé en inversant le P&L complet avec les réglages du site.',
      r: 'Comparer aux membres réalistes → coussin de sécurité' },
