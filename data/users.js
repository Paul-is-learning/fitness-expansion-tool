...
const CANONICAL_USERS = [
  {email:'paulbecaud@isseo-dev.com',role:'admin',name:'Paul Becaud',pwHash:simpleHash('123456'),recoveryHash:simpleHash('FP2026-BECAUD')},
  {email:'pbecaud@isseo-dev.com',role:'admin',name:'Paul Becaud',pwHash:simpleHash('123456'),recoveryHash:simpleHash('FP2026-BECAUD')},
